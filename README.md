...
Ứng dụng full-stack hoàn chỉnh giúp phân loại và tổ chức danh sách asset/phòng của một dự án số hóa 3D tự động bằng cách sử dụng Next.js 16 (App Router), React 19 và Gemini 2.5 Flash API.
...
│   ├── globals.css            # CSS toàn cục cho Tailwind CSS v4
...
│   ├── CategoryCard.tsx       # Hiển thị bảng danh mục & đề xuất slug
│   ├── MetadataCard.tsx       # Hiển thị thông tin thống kê dự án
